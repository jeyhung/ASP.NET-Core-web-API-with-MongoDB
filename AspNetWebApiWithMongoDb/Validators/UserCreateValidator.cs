...
{
    private readonly IValidator<UserAddressCreateDto> _userAddressValidator;

    public UserCreateValidator(IValidator<UserAddressCreateDto> userAddressValidator)
    {
    ...
    private async Task<bool> UserAddressValidationAsync(IList<UserAddressCreateDto> userAddresses,
        CancellationToken cancellationToken)
    {
        ...
        foreach (UserAddressCreateDto userAddress in userAddresses)
        {
